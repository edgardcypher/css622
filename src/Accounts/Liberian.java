...
public class Liberian extends Account {
	...
	public boolean addBook(List<Book> listBooks, Scanner scanner ) {
    ...
    * */
	...
	private BookItem captureAndWriteBookInformation() throws BadInputException, BadDateFormatException {
		...
		newBook.setPublicationDate(LocalDate.parse(datePurchase, formatter).atStartOfDay());
		...
		writeNewBookInfoIntoTable(newBookInfo);// write the book information in the file
		return newBook;
	}
	
	/*Function to write book information to the file
	 * */
	private static void writeNewBookInfoIntoTable(String newBookInfo) {
